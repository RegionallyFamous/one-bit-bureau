...
def render() -> None:
  ...
  <g transform="translate(820 70)"><image href="data:image/png;base64,{encoded}" width="760" height="475" preserveAspectRatio="xMidYMid slice"/><rect y="475" width="760" height="28" fill="#171716"/><text x="380" y="494" text-anchor="middle" fill="#f4f4f0" font-family="DejaVu Sans Mono, monospace" font-size="12">16:10 COVER CROP</text></g>
  <g transform="translate(20 610)"><image href="data:image/png;base64,{encoded}" width="760" height="326" preserveAspectRatio="xMidYMid slice"/><rect y="326" width="760" height="28" fill="#171716"/><text x="380" y="345" text-anchor="middle" fill="#f4f4f0" font-family="DejaVu Sans Mono, monospace" font-size="12">21:9 COVER CROP</text></g>
  <g transform="translate(820 610)"><image href="data:image/png;base64,{encoded}" width="760" height="570" preserveAspectRatio="xMidYMid slice"/><rect y="570" width="760" height="28" fill="#171716"/><text x="380" y="589" text-anchor="middle" fill="#f4f4f0" font-family="DejaVu Sans Mono, monospace" font-size="12">4:3 SAFETY CROP</text></g>
</svg>'''
