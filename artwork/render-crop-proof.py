...
def render() -> None:
  ...
  <g transform="translate(20 610)"><image href="data:image/png;base64,{encoded}" width="760" height="326" preserveAspectRatio="xMinYMid slice"/><rect y="326" width="760" height="28" fill="#171716"/><text x="380" y="345" text-anchor="middle" fill="#f4f4f0" font-family="DejaVu Sans Mono, monospace" font-size="12">21:9 OFF-CENTER CROP</text></g>
