...
class DesktopQmlContractTest(unittest.TestCase):
    ...
    def test_photo_selection_changes_only_its_enclosure_and_name_rail(self) -> None:
        ...
        self.assertIn("A real picture never changes pixels", SERVICE)
        self.assertNotIn("layer.effect", SERVICE)
